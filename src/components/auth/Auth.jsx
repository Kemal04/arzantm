    ...
    return (
        <>
            <Modal show={show} onHide={onHide}>
                ...
                <div className="modal-body">
                    <div className="tab-content" id="pills-tabContent">
                        {/* Login */}
                        <form onSubmit={loginUser} className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex="0">
                            <div className="d-flex justify-content-center align-items-center flex-column">

                                <input value={login_phone} onChange={(e) => setLogin_phone(e.target.value)} name='phone' className="form-control ps-5" type="text" placeholder="Telefon belgisi" style={{ background: `url(${phone_img}) no-repeat left`, backgroundPositionX: "20px", width: "400px" }} />
                            ...
                            <div className="border-0 d-grid mt-3" style={{ justifyContent: 'unset' }}>
                                <button type="submit" className="btn btn-green">Ulgama gir</button>
                            </div>
                        </form>
                        {/* Login */}
            ...
            <Modal show={show2} onHide={handleClose2}>
                ...
                <div className="modal-body">
                    <button className='btn btn-primary' onClick={checkSmsClick}>SMS ugratdym</button>
                </div>
            </Modal >
