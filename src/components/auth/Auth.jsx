...
const Auth = () => {
    ...
    const registerUser = async (e) => {
        ...
        const data = { name: name, phone: phone, password: pass }

        await axios.post(`/api/v1/account/signup`, data).then((res) => {
    ...
    const loginUser = async (e) => {
        ...
        const data = { phone: login_phone, password: login_pass }
                            ...
                            <div className="tab-content" id="pills-tabContent">
                                ...
                                <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabIndex="0">
                                    <div className="d-flex justify-content-center align-items-center flex-column">
                                        <input required value={login_phone} onChange={(e) => setLogin_phone(e.target.value)} name='phone' className="form-control ps-5" type="text" placeholder="Telefon belgisi" style={{ background: `url(${phone_img}) no-repeat left`, backgroundPositionX: "20px", width: "400px" }} />
                                        <div className="input-group ms-3 mb-4">
                                            <input required value={login_pass} onChange={(e) => setLogin_Password(e.target.value)} name='password' className="form-control ps-5 mt-4 border-end-0 flex-grow-0" type={!isVisible1 ? "password" : "text"} placeholder="Açar sözi" style={{ background: `url(${key}) no-repeat left`, backgroundPositionX: "20px", width: "360px" }} />
                                ...
                                <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabIndex="0">
                                    <div className="d-flex justify-content-center flex-column">
                                        ...
                                        <input value={phone} onChange={(e) => setPhone(e.target.value)} type="text" name='phone' className="form-control ps-5 mb-4" placeholder="Telefon belgisi" style={{ background: `url(${phone_img}) no-repeat left`, backgroundPositionX: "20px", width: "400px" }} />
